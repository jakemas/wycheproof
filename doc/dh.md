...
[[NIST-SP800-56A]](bib.md#nist-sp800-56a) rev. 3, Section 5.5.1.1 only requires
that the size of the subgroup generated by the generator g is big enough to
prevent the baby-step giant-step algorithm. I.e., for 112-bit security p must be
at least 2048 bits long and the prime q must be at least 224 bits long. To avoid
